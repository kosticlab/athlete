...
t_abundances <- read.csv("/Users/jacobluber/Desktop/athlete_metadata/head.csv",header=TRUE,row.names=1)
...
write.csv(genomics, file = "all_genomics.csv")
write.csv(transcriptomics,file ="all_transcriptomics.csv")
write.csv(all,file="all_all.csv")
