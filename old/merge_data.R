...
t_abundances <- read.csv("/Users/jacobluber/Desktop/athlete_metadata/veill/v_abundances_t.csv",header=TRUE)
...
write.csv(genomics, file = "v_genomics.csv")
write.csv(transcriptomics,file ="v_transcriptomics.csv")
write.csv(all,file="v_all.csv")
